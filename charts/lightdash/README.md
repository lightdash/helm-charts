...
| scheduler.livenessProbe.path | string | `"/api/v1/health"` |  |
...
| scheduler.readinessProbe.periodSeconds | int | `30` |  |
...
| scheduler.startupProbe.failureThreshold | int | `30` |  |
| scheduler.startupProbe.initialDelaySeconds | int | `10` |  |
| scheduler.startupProbe.path | string | `"/api/v1/livez"` |  |
| scheduler.startupProbe.periodSeconds | int | `10` |  |
| scheduler.startupProbe.timeoutSeconds | int | `5` |  |
